            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-5 sm:mt-7 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center rounded-xl bg-[#1C1C1C] px-6 py-4 sm:py-3.5 text-sm font-semibold text-white shadow-lg hover:opacity-90 active:opacity-80 focus:outline-none focus:ring-4 focus:ring-[#D6B6B6]/40"
