          ...
          <div className="relative mx-auto max-w-6xl px-4 py-10 sm:py-14 md:py-20">
            <div className="flex flex-col items-center text-center">
              ...
              <img
                ...
                className="mt-6 sm:mt-8 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 object-contain rounded-full border-2 border-[#D6B6B6]/60 shadow-[0_0_20px_rgba(214,182,182,0.45),0_0_40px_rgba(201,160,160,0.25)] animate-pulse-expand"
              ...
              <div className="mt-5 sm:mt-7 flex flex-col items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center rounded-xl bg-[#C9A0A0] px-8 py-5 sm:px-10 sm:py-4 text-base font-bold text-white shadow-xl hover:opacity-90 active:opacity-80 focus:outline-none focus:ring-4 focus:ring-[#D6B6B6]/40"
